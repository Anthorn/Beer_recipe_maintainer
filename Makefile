...
SRCS := parsable.cc beerData.cc equipment.cc fermentable.cc fermentables.cc hop.cc hops.cc\
	style.cc water.cc waterprofile.cc yeasts.cc yeast.cc mashStep.cc \
